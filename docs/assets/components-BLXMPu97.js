(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();function m(){const s=document.createElement("nav");s.className="fixed left-0 right-0 bottom-0 md:top-0 md:bottom-auto bg-white dark:bg-slate-800 border-t md:border-b md:border-t-0 border-gray-200 dark:border-slate-700 shadow-sm pb-[env(safe-area-inset-bottom)] md:pb-0",s.style.zIndex=1e3;const r=window.location.pathname.includes("/freebulder.html");return s.innerHTML=`
      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center space-x-4">
          ...
          <a
            ...
            class="${r?"hidden":"block"} text-xs md:text-base px-4 py-2 bg-slate-800 hover:bg-slate-950 text-white dark:bg-white dark:text-slate-800 font-medium transition-colors"
          >
            Start Making
          </a>
        </div>
  ...
  `,s}function g(){const s=m();document.body.insertBefore(s,document.body.firstChild);function r(){window.matchMedia("(min-width: 768px)").matches?(document.body.style.paddingTop="4rem",document.body.style.paddingBottom=""):(document.body.style.paddingTop="",document.body.style.paddingBottom="calc(4rem + env(safe-area-inset-bottom))")}r(),window.addEventListener("resize",r),window.addEventListener("orientationchange",r);const o=document.getElementById("themeSystem"),a=document.getElementById("themeLight"),e=document.getElementById("themeDark"),t=document.documentElement;let l=localStorage.getItem("theme")||"system";function d(n){l=n,localStorage.setItem("theme",n),document.querySelectorAll(".theme-btn").forEach(c=>{c.classList.remove("bg-white","dark:bg-slate-600","text-gray-900","dark:text-gray-100","shadow-sm"),c.classList.add("text-gray-600","dark:text-gray-400")});let i;n==="system"?(i=o,window.matchMedia("(prefers-color-scheme: dark)").matches?t.classList.add("dark"):t.classList.remove("dark")):n==="light"?(i=a,t.classList.remove("dark")):n==="dark"&&(i=e,t.classList.add("dark")),i&&(i.classList.remove("text-gray-600","dark:text-gray-400"),i.classList.add("bg-white","dark:bg-slate-600","text-gray-900","dark:text-gray-100","shadow-sm"))}d(l),o.addEventListener("click",()=>d("system")),a.addEventListener("click",()=>d("light")),e.addEventListener("click",()=>d("dark")),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",n=>{l==="system"&&d("system")})}function h(){const s=document.createElement("footer");return s.className="bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 mt-16 mb-0 pb-16",s.innerHTML=`
