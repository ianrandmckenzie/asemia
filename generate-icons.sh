...
# Icon Generator Script for Asemic Typeform Crafter
...
echo "🎨 Asemic Typeform Crafter Icon Generator"
echo ""
...
{
    "name": "Asemic Typeform Crafter - Interactive Sound Grid",
    "short_name": "Asemic Typeform Crafter",
